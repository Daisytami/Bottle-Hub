    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "All Items",fontSize = 30.sp, color = Color.Black)
                },
                navigationIcon = {
                    IconButton(onClick = {
                ...
                colors = TopAppBarDefaults.topAppBarColors(
                    containerColor = Color(0xff23B0B7),
                ...
                if (isLoading) {
                    ...
                    if (productList.isEmpty()) {
                        ...
                        if (displayedProductCount < productList.size) {
                            Button(
                                colors = ButtonDefaults.buttonColors(backgroundColor = Color(0xff23B0B7)),
